...
def start_encryption():
	...
	enc.encrypter()
	return render_template('success.html', id=str(random.randint(999999,9999999)))

def start_decryption():
	dec.decrypter()
	tools.empty_folder('key')
	rst.restore()
	return render_template('restore_success.html', id=str(random.randint(999999,9999999)))

@app.route('/return-key/<randomint>')
def return_key(randomint):
...
@app.route('/return-file/<randomint>')
def return_file(randomint):
